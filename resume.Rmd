...
aboutme: "I enjoy solving relevant, challenging problems in science using computational approaches."
headcolor: "0F2137"
output: 
  vitae::moderncv:
    theme: "fancy"
...
tribble(
  ...
  c("Developed a full prokaryotic pangenomics machine learning (ML) pipeline that collects data from bvbrc, annotates genomes, and generates a pangenome of gene clusters serving as input for predictive anbitiotic resistance ML classifiers",
    "Testing performance across various ML methods Random Forest, Support Vector Machine, and XGBoost across multiple pathogenic organisms (ESKAPE & more)",
